...
public class FindTrains {
	...
	static int position;
	Map map = new Map();
	static boolean inDirectExists = false;
	
	FindTrains() {
		
	}
	
	FindTrains(String sourceName, String sourceCode, String destinationName, String destinationCode)
	{
			...
			Station allStation[] = train.getAllStation();
				...
				{	
					...
					if(connectedStation.get(position)!=null)
						{
						System.out.println( train.getTrainName()+" station: "+connectedStation.get(position).getStationName()+" : " + station.getStationName());
						
						//System.out.println("CS: "+connectedStation.get(position).getStationName());
						...
						{	//System.out.println( train.getTrainName());
							...
							//		System.out.println( train.getTrainName()+" station: "+station.next.getStationCode() +" : " + (destinationStation.getStationCode()));
	...
	{	
		...
		FindTrains findTrain = new FindTrains(sourceName, sourceCode, destinationName, destinationCode);
